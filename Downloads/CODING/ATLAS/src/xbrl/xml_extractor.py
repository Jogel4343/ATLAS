"""
Extract XBRL facts from traditional XBRL XML instance documents.
"""
...
def _extract_namespace_prefix(tag: str, root) -> str:
    """
...
def extract_xml_xbrl(xml_path: str) -> Dict[str, Any]:
    """
